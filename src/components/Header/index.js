...
const Header = () => {
  ...
  return (
    <header className="w-full p-4 px-5 sm:px-10 flex items-center justify-between ">
      ...
      <button className="inline-block sm:hidden z-50" onClick={() => setClick(toggle)}>
        <div className="w-6 cursor-pointer transition-all ease duration-300">
          <div className="relative">
            <span className="absolute top-0 inline-block w-full h-0.5 bg-dark dark:bg-light transition-all ease duration-200"
